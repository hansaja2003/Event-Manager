...
const AdminSidebar = () => {
    ...
    const navItems = [
        ...
        { path: '/admin/reports/dashboard', icon: '📌', label: 'Reports Dashboard' },
        { path: '/admin/reports/events', icon: '🧾', label: 'Unified Reports' },
        { path: '/admin/reports/export', icon: '⬇️', label: 'Export Reports' },
        { path: '/admin/reviews/events', icon: '🗂️', label: 'Event Review List' },
        { path: '/admin/reviews/analytics', icon: '⭐', label: 'Review Analytics' },
